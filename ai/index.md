...
- 线性代数：重点是向量、矩阵、张量、特征值、奇异值分解。。
- 微积分：重点是导数、梯度、链式法则。
- 概率与统计：重点是概率分布、贝叶斯定理、期望与方差、假设检验。
...
[machine-learning-yearning-cn](https://github.com/deeplearning-ai/machine-learning-yearning-cn.git)
