...
PWA -> Progressive Web App 渐近式 Web 应用
SDK -> Software Development Kit 软件开发工具包
IDE -> Integrated Development Envirnment 集成开发环境
SOA -> Service-Oriented Architecture 面向服务架构
ORM -> Object Relation Mapping 对象关系映射
MVC -> Model View Controller 模型视图框架软件设计模式
OOP -> Object Oriented programing 面向对象编程
BEM -> Block Element Modifier 块-元素-修饰符
BFC -> Block Format Context 块级格式化上下文
SKU -> Stock Keeping Unit 库存单位
AJAX -> Asynchronous JavaScript and XML 异步 js 和 xml，即异步信息交换。
...
table,chart, graph, diagram: 表格，图表，曲线图，示意图
system: 系统、体系
guards: 保障、守卫
