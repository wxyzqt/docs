...
博客需要翻阅文档；个人网站维护需要耗费精力；书签使用不算方便；在线导航页签定制麻烦且需要考虑网站存续问题。
...
.vitepress/sidebars/，导航栏具体配置文件夹

本仓库采用的是 vitepress，想要更丰富的页面外观可以根据[vitepress](https://github.com/vuejs/vitepress)和[vitepress 中文文档](https://vitepress.dev/zh/)自行修改。
