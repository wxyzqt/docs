...
较热门的库多数自带类型，找不到库的类型文件时，先去[DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped)查一查，[中文 readme](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/README.zh-Hans.md)
