...
文件后缀名并不会影响文件的内容和格式，影响的是文件的打开方式。
...
| ‌.mp4  | 主流视频格式                               |
| ‌.avi  | 早期视频格式                               |
| .mov   | 视频文件，Apple 设计的视频格式             |
| .flv   | 视频文件，主要用于网络流媒体播放           |

:::tip
MPEG 是专注于运动图像及其伴音编码的标准化工作的技术委员会，mp3、mp4 都是其针对音视频编码压缩推行的标准。
:::
...
| ​.wasm​     | ​ WebAssembly,编程语言编译成的二进制文件，从而可以运行在浏览器上，实现更复杂的应用 |
